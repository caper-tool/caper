...
pvar = VarPermExpr p0 . Variable p0
...
grds r gds = AssrtSpatial p0 $ SAGuards $ Guards p0 r gds
...
a5 = a4 &*& grds "r" [PermGuard p0 "A" (ConstPermExpr p0 FullPerm)]
a6 = a4 &*& grds "r" [PermGuard p0 "A" (pvar "p")]
a7 = aregs &*& (vr "s" /== cve 2) &*& grds "r" [PermGuard p0 "A" (pvar "p")]
